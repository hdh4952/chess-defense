 ...
 * ============================================================================
 *
 * - throttleMs: 폰은 ~120ms, 나머지는 ~200ms로 시작 (스펙 지정값). 폰은 비무장 쿨다운(0.5s)이라
 *   가장 자주 겹치므로 더 촘촘히 허용하되, 그래도 초당 8회를 넘는 스트림은 막는다.
 * - gain: 폰은 8마리가 동시에 울릴 수 있는 잦은 소리라 믹스에서 가장 낮게, 나이트(블라스트)는
